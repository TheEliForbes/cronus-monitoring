...
echo $KURL:9092
kapacitor-unit -kapacitor http://$KURL:9092 -influxdb http://$IURL:8086 -dir ../gtikk-charts/kapacitor/TICKscripts/stream -tests ../gtikk-charts/kapacitor/TICKscripts/tests/*.yaml