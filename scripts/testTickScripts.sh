...
echo $KURL:9092
kapacitor-unit -kapacitor http://$KURL:9092 -influxdb http://$IURL:8086 -dir ../charts/kapacitor/TICKscripts/test_scripts -tests ../gtikk-charts/kapacitor/TICKscripts/tests/all_tests.yaml
