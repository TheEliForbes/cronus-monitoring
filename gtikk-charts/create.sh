...
helm install --name polling --set influxurl=$IFDB_URL --namespace kube-system ./telegraf-s/
helm install --name hosts --set influxurl=$IFDB_URL --namespace kube-system ./telegraf-ds/
